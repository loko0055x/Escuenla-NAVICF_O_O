    ...
    >
      ...
      <div className="relative h-full flex flex-col p-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center -mt-20">
          <h1 className="text-6xl font-bold mb-2" style={{ color: "#00A7E1" }}>
            CERTIFICADO
          </h1>

          <p className="text-sm font-medium text-gray-600 tracking-widest mt-4">
            OTORGADO A:
          </p>
          ...
          <p className="text-lg font-bold text-gray-900 mb-6">DNI: {dni}</p>
          ...
          <p className="text-sm text-gray-700 mb-8">
            En periodo programado de {fechainicio} - {fechafin} con una duración
            de 120 horas teórico y práctico.
          </p>

          <p className="text-lg font-bold text-gray-900">
            {ciudad}, {currentDate.toLocaleUpperCase()}
          </p>
        </div>
